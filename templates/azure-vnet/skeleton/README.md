...
```
.
├── main.tf                 # Root module calling the VNet module
...
├── tests/
│   └── vnet.tftest.hcl     # Terraform native tests
└── .github/
    └── workflows/
...
| ----------- | ----------------------------- | ---------------------------- |
| dev         | `environments/dev.tfvars`     | Development environment      |
| staging     | `environments/staging.tfvars` | Staging environment          |
| prod        | `environments/prod.tfvars`    | Production - DDoS protection |
